...
if(!$id || !$student_id || !$first_name || !$last_name || !$section) 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" class="bg-light border border-primary rounded px-5"> 
        ...
        <input value="<?php echo $student_id ?>" type="text" class="form-control" placeholder="School ID" aria-label="SchoolID" aria-describedby="basic-addon1" name="student_id" required>
        </div>
