  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" class="bg-light border border-primary rounded px-5">
        ...
        <!-- ADD STUDENT MODAL -->
        <h1 class="text-center pt-3 fw-bold fst-italic">Add Instructor</h1>
        ...
        <div class="d-flex justify-content-evenly py-2 mb-4">
          <input type="submit" class="btn btn-success btn-lg mx-2" name="addingInstructorSubmit" value="Add User"></input>
...
if (isset($_POST['addingInstructorSubmit'])) {
  ...
  $checkSchoolID = mysqli_query($con, "SELECT *  FROM instructors where school_id = '$school_id' ");
...
<?php
    ...
    $res = $con->query("INSERT INTO `instructors`(`school_id`, `first_name`, `last_name`, `status`) 
  VALUES ('$school_id','$fname','$lname', 1)");

$sql = "INSERT INTO `users`(`school_id`, `first_name`, `last_name`, `password`, `role`) 
VALUES ('$school_id', '$fname', '$lname', '$hashedpassword', 'instructor')";
$con->query($sql);
