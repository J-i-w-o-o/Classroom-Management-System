 ...
 <div class="container pt-4">
    <div class="container-lg p-1 bg-white rounded">
      <div class="container text-end pd-5">
        <button type="button" class="btn btn-success  mb-3 mt-2 fs-6" data-toggle="modal" data-target="#adminModal">
      ...
      "columns": [{
        ...
        },
        {
          ...
          render: function(data, type, row) {
            return '<center><a  href="admin_components/action.php?role=admin&action=edit&id=' + data + '"><button type="submit" class="btn btn-primary mx-1">Edit<i class="fa-solid fa-pen-to-square h5"></i></button></a><a href="admin_components/action.php?role=admin&action=delete&id=' + data + '" class="text-white text-decoration-none"><button type="submit" class="btn btn-danger mx-1 ">Delete<i class="fa fa-trash h5" aria-hidden="true"></i></button></a></center>'
          }
        }
      ],
      columnDefs: [{
