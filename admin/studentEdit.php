...
if (!$id || !$school_id1 || !$first_name1 || !$last_name1 || !$section)
        ...
        <div class="modal-content">
          ...
          <form method="post" class="bg-light border border-primary rounded p-5 ">
            ...
            <div class="input-group mb-4">
              ...
              <input value="<?php echo $school_id1 ?>" type="text" class="form-control" placeholder="School ID" aria-label="SchoolID" aria-describedby="basic-addon1" name="school_id2" required>
            </div>
