 ...
 <div class="container pt-4">
    <div class="container-lg p-1 bg-white rounded">
      ...
      <div class="container text-start pd-5" id="section_wrapper">
        <table id="sectionView" class=" table-bordered display responsive compact table table-striped" width="100%  ">
          <thead>
            <tr>
              <th class="">ID</th>
              <th class="">COURSE</th>
      ...
      "columns": [{
        ...
        },
        {
          ...
          render: function(data, type, row) {
            return '<center><a href="admin_components/action.php?role=section&action=edit&id1=' + data + '"><button type="submit" class="btn btn-primary mx-1">Edit<i class="fa-solid fa-pen-to-square h5"></i></button></a><a href="admin_components/action.php?role=section&action=delete&id1=' + data + '" class="text-white text-decoration-none"><button type="submit" class="btn btn-danger mx-1 ">Delete<i class="fa fa-trash h5" aria-hidden="true"></i></button></a></center>'
          }
        }
      ]
    });
